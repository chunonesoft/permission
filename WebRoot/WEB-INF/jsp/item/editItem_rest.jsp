...
<form:errors path="*" cssStyle="color:red"></form:errors><br/>
	...
	<form id="itemForm"
		action="${pageContext.request.contextPath }/item/editItemSubmit"
		...
		<table width="100%" border=1>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" value="提交" />
					<input type="button" value="ajax提交，提交json串"
					onclick="request_json()" /> <input type="button"
					value="ajax提交，普通form提交" onclick="response_json()" /></td>
			</tr>
		</table>
